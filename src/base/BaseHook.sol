...
// Vendored from https://github.com/Uniswap/v4-hooks-public/blob/main/src/base/BaseHook.sol (commit e4eabe5).
// v4-periphery no longer ships BaseHook. Only the pragma was pinned; logic is unchanged.
