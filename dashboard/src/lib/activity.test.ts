...
const d: Deployments = {
  ...
  orgResolver: "0x5112C1F6bF910DC0B127BE2B109Dc484168c668F",
...
describe("buildActivity", () => {
  const logs = [
    log("LabelRegistered", { tokenId: 7n, label: "trader-2", expiry: 1_800_000_000n }, 10),
    log("Linked", { recordId: 2n, node: node2 }, 11),
    log(
      "TextUpdated",
      { recordId: 2n, key: "leash.dailyNotional", value: "100000000000000000000" },
      11,
      1,
    ),
    log("TextUpdated", { recordId: 2n, key: "leash.maxSlippageBps", value: "50" }, 11, 2),
    log(
      "TextUpdated",
      { recordId: 2n, key: "leash.dailyNotional", value: "10000000000000000000" },
      12,
      0,
    ),
